...
export const metadata: Metadata = {
  ...
  description: "Account, billing, contributor, and editorial contact paths for Sports Rewritten.",
  ...
  return (
    <>
      ...
      <main className="shell" style={{maxWidth:900,padding:"56px 0 80px"}}>
        ...
        <p style={{fontSize:19,lineHeight:1.7,color:"#c4ccd0"}}>The site currently handles reader accounts, billing, and contributor activity through dedicated tools while a public support inbox is being established.</p>
